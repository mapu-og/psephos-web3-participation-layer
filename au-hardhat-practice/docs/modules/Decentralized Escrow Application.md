...
A Hardhat project is configured in the base directory of the escrow project. We'll be using hardhat tooling to write, test and deploy our contracts.
...
(link: https://www.web3.university/article/how-to-build-a-react-dapp-with-hardhat-and-metamask)
...
Try running the Escrow dApp on the Sepolia testnet. This involves you deploying the smart contract to the Sepolia test network.

Need an Alchemy endpoint in order to deploy to a testnet? Get one here.

You can acquire some testnet ether via this faucet.
